...
const Clubs = () => {
    return(
        ...
        <section className="ACSU">
            <a href="https://acsu.cornell.edu/"><img src={ACSU} /></a>
        ...
        <section className="WICC">
            <a href="https://wicc.cornell.edu/"><img src={WICC} /></a>
        ...
        <section className="URMC">
            <a href="https://urmc-website.herokuapp.com"><img src={URMC} /></a>
        ...
        <section className="ISSA">
            <a href="https://issa.infosci.cornell.edu"><img src={ISSA} /></a>
