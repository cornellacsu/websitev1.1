        ...
        <section className="Courses">
            ...
            <section className="Core">
                ...
                <Accordion
                    ...
                    <br></br>
                    The projects are very straightforward and as long as you’re paying attention in class/lab and reading instructions carefully, you’ll do well. The most noteworthy project is the last one where you’ll be tasked to create a interactive game.
                    <br></br>
                ...
                <Accordion
                    ...
                    <li>induction (strong, weak, structural)</li>
                    </ul>
                    <br>
                    ...
                    <li>not buy any textbooks (because there isn’t an official one!)</li>
                    </ol>
                ...
                <Accordion
                    ...
                    <br></br>
                    The course consists of three lectures as well as one weekly recitation taught by undergraduate TAs. The recitations are a fantastic resource for not only asking questions and clarifying concepts with peers, but also gaining hands-on experience, as some recitations involve coding. Recitations will not only go in-depth on important topics covered in lecture, but also cover topics more directly related to problem sets.
                    <br></br>
                    This course, like CS 3410, is a significant jump in difficulty/workload from CS 2110, so it would definitely be wise to start projects early and stay on top of the material if you haven’t gotten into this habit already. There are usually 5-7 projects that consist mostly of programming in OCaml. In the past, the course has varied with regards to working with partners. When it was taught by Constable, for example, it featured mostly individual projects; only one was in pairs. There have also been semesters where all projects were pair or group projects. In Clarkson's offering, the first few projects were individual, and the final project was a group project with 3-4 team members. Historically, this final project allows each group more freedom in their software engineering choices, but also expects much more creativity and ingenuity to come from the assignment.
                    <br></br>
                    Helpful links:
                    <ul>
                    <li><a href=https://dev.realworldocaml.org>Real World OCaml</a>, a book available for free online that is often used as a supplementary text in the course</li>
                    <li>Depending on your background experience, this might be the first course in which you will be exposed to Git, a system that allows remote users to work on coding assignments together. Git can be very scary and confusing for the first time, so <a href=https://learngitbranching.js.org>brushing upon the basics</a> before the course begins may save some headaches during the semester.</li></ul>
                    <br>
                    <b>📅 Offered:</b> Every semester
                    <br>
                ...
                <Accordion
                    ...
                    content="This course stays true to its name and exposes students to various algorithms while also proving their correctness and optimality and analyzing their runtime. The types of algorithms introduced include…
                    <br></br>
                    <ul>
                    ...
                    <b>📅 Offered:</b> Every semester
                    <br>
                    <b>✅ Prerequisites:</b> CS 2800 and CS 3110 (If you received both an A- or above in 2110 and 2800, you are allowed to take this course without having to have taken CS 3110)
                    <br>
            ...
            <section className="Alternatives">
                ...
                <Accordion
                    ...
                    <br>
                    <ul>
                    <li>Prelims are very difficult, so preparing a lot beforehand plays a huge role. Doing the practice problems and prelims are very useful in preparing</li>
                    <li>The problem sets take a significant amount of time, so starting early is always important.</li>
                    <li>Because the material varies from the professors teaching it, don’t rely on previous prelims to be a good indicator of what the prelim for your semester will be like (unless the same professor is teaching it).  </li>
                    </ul>
                    <br>
                    <b>📅 Offered:</b> Varies
                    <br>
                    <b>✅ Prerequisites:</b> One programming course or permission of instructor.
                    <br>
                    <b>📔 Historical Median Grade:</b> B+
                    <br>
                    <b>⏰ Workload:</b> 8-12 hours a week
                    <br>
                    <b>📝 Notes</b>: Problem set questions can vary from six to eight questions from the textbook. Some questions might be straight-forward calculations and answers, while others can be proof questions that often can be rather challenging. But if you ever get stuck and need help, there are office hours throughout the entire week that you can go and get help.
                    "
                />
                <Accordion
                    ...
                    <br></br>
                    The course also has a few written homeworks that are graded pass/fail based on if you get 60% of it right, but they require little to no time to complete. Once a week, there will be a short iClicker quiz as well covering the topics lectured from the previous week.
                    <br></br>
